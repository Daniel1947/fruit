...
(function (e) {
    ...
    FlipClock.Base = Base.extend({buildDate: "2013-04-16", version: "0.1.2", constructor: function (t, n) {
        typeof t != "object" && (t = {});
        typeof n != "object" && (n = {});
    ...
    FlipClock.Factory = FlipClock.Base.extend({autoStart: !0, callbacks: {destroy: !1, create: !1, init: !1, interval: !1, start: !1, stop: !1, reset: !1}, classes: {active: "flip-clock-active", before: "flip-clock-before", divider: "flip-clock-divider", dot: "flip-clock-dot", label: "flip-clock-label", flip: "flip", play: "play", wrapper: "flip-clock-wrapper"}, clockFace: "HourlyCounter", defaultClockFace: "HourlyCounter", face: !0, running: !1, time: !1, timer: !1, lists: [], $wrapper: !1, constructor: function (t, n, r) {
        this.base(r);
    ...
    FlipClock.Face = FlipClock.Base.extend({factory: !1, lists: [], constructor: function (e, t) {
        this.base(t);
        this.factory = e
    }, build: function () {
...
//        var r = ['<span class="' + this.factory.classes.dot + ' top"></span>', '<span class="' + this.factory.classes.dot + ' bottom"></span>'].join("");
        ...
        var t = this.createList(e, {classes: {active: this.factory.classes.active, before: this.factory.classes.before, flip: this.factory.classes.flip}});
    ...
    FlipClock.List = FlipClock.Base.extend({digit: 0, classes: {active: "flip-clock-active", before: "flip-clock-before", flip: "flip"}, factory: !1, $obj: !1, items: [], constructor: function (e, t, n) {
        this.factory = e;
        this.digit = t;
        ...
        var t = this.$obj.find('[data-digit="' + e + '"]'), n = this.$obj.find("." + this.classes.active).removeClass(this.classes.active), r = this.$obj.find("." + this.classes.before).removeClass(this.classes.before);
    ...
    FlipClock.Time = FlipClock.Base.extend({minimumDigits: 0, time: 0, factory: !1, constructor: function (e, t, n) {
        this.base(n);
        this.factory = e;
        t && (this.time = t)
        ...
        var e = new Date, t = e.getHours(), n = t > 12 ? "PM" : "AM", r = this.digitize([t > 12 ? t - 12 : t === 0 ? 12 : t, e.getMinutes(), e.getSeconds()]);
        return r
    }, getWeeks: function () {
    ...
    FlipClock.Timer = FlipClock.Base.extend({callbacks: {destroy: !1, create: !1, init: !1, interval: !1, start: !1, stop: !1, reset: !1}, count: 0, factory: !1, interval: 1e3, constructor: function (e, t) {
        this.base(t);
        this.factory = e;
...
(function (e) {
    FlipClock.MinuteCounterFace = FlipClock.HourlyCounterFace.extend({constructor: function (e, t) {
        this.base(e, t)
    }, build: function () {
...
(function (e) {
    FlipClock.TwentyFourHourClockFace = FlipClock.Face.extend({dividers: [], build: function (t) {
        ...
        var e = this.factory.lists[this.factory.lists.length - 2], t = this.factory.lists[this.factory.lists.length - 4];
        for (var n = 10; n < 10; n++) {
            e.$obj.find("li:last-child").remove();
            t.$obj.find("li:last-child").remove()
        }
...
(function (e) {
    FlipClock.TwelveHourClockFace = FlipClock.TwentyFourHourClockFace.extend({meridium: !1, meridiumText: "AM", build: function (t) {
        var n = this;
...
(function (e) {
    FlipClock.DailyCounterFace = FlipClock.Face.extend({constructor: function (e, t) {
        this.base(e, t)
    }, build: function (t, n) {
        var r = this, i = this.factory.$wrapper.find("ul"), s = [];
